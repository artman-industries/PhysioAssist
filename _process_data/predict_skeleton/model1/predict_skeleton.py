...
NAME_DICT = {'pelv': 'pelvis', 'lhip': 'left_hip', 'rhip': 'right_hip', 'bell': 'belly', 'lkne': 'left_knee', 'rkne': 'right_knee', 'spin': 'spine', 'lank': 'left_ankle', 'rank': 'right_ankle', 'thor': 'thorax', 'ltoe': 'left_toe', 'rtoe': 'right_toe', 'neck': 'neck', 'lcla': 'left_claw', 'rcla': 'right_claw', 'head': 'head', 'lsho': 'left_shoulder', 'rsho': 'right_shoulder', 'lelb': 'left_elbow', 'relb': 'right_elbow', 'lwri': 'left_wrist', 'rwri': 'right_wrist', 'lhan': 'left_hand', 'rhan': 'right_hand', 'nose': 'nose', 'leye': 'left_eye', 'lear': 'left_ear', 'reye': 'right_eye', 'rear': 'right_ear', 'rfoo': 'right_foot', 'lfoo': 'left_foot', 'htop': 'head_top', 'lthu': 'left_thumb', 'rthu': 'right_thumb', 'lfin': 'left_finger', 'rfin': 'right_finger'}
